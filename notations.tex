...
\newglossaryentry{not:Segrevar}{
  ...
  description={Segre variety at $q$},
}
...
\newglossaryentry{not:Szegoker}{
  name={$S_U(z,\bar{\zeta})$},
  description={Szeg{\H{o}} kernel of $U$},
}
...
\newglossaryentry{not:closure}{
  name={$\overline{S}$},
  description={topological closure of $S$},
}

\newglossaryentry{not:complement}{
  name={$X^c$},
  description={complement of $X$},
}

\newglossaryentry{not:interior}{
  name={$S^\circ$},
  description={interior of $S$},
}
