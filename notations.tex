...
\newglossaryentry{not:PSH}{
  type=notation,
  name={$PSH(U)$},
  description={plurisubharmonic functions on $U$},
}
...
\newglossaryentry{not:dist}{
  type=notation,
  name={$\operatorname{dist}(x,y)$, $\operatorname{dist}(x,S)$,
...
\newglossaryentry{not:A2}{
  type=notation,
  name={$A^2(U)$},
  description={Bergman space, square integrable holomorphic functions},
}
